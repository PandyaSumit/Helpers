            ...
            <div className="sticky top-20 rounded-2xl border border-neutral-100 bg-white p-6 shadow-sm">
              ...
              <div className="mt-6 space-y-3 border-t border-neutral-100 pt-5">
                <div className="flex items-start justify-between gap-2">
                  ...
                  <span className="text-xs font-medium text-neutral-700">{job.company}</span>
                </div>
                <div className="flex items-start justify-between gap-2">
                  <span className="text-xs text-neutral-400">Location</span>
                  <span className="text-xs font-medium text-neutral-700">{job.location}</span>
                </div>
                <div className="flex items-start justify-between gap-2">
                  <span className="text-xs text-neutral-400">Type</span>
                  <span className="text-xs font-medium text-neutral-700">{jobTypeLabel(job.jobType)}</span>
                </div>
                <div className="flex items-start justify-between gap-2">
                  <span className="text-xs text-neutral-400">Level</span>
                  <span className="text-xs font-medium text-neutral-700">{experienceLevelLabel(job.experienceLevel)}</span>
                </div>
                <div className="flex items-start justify-between gap-2">
                  <span className="text-xs text-neutral-400">Category</span>
                  <span className="text-xs font-medium text-neutral-700">{job.category}</span>
                </div>
                {job.salary && (
                  <div className="flex items-start justify-between gap-2">
                    <span className="text-xs text-neutral-400">Salary</span>
                    <span className="text-xs font-medium text-neutral-700">{formatSalary(job)}</span>
                  </div>
                )}
              </div>
